		...
		<template v-if="showFlag">
			...
			<el-card shadow="hover" :style='{"border":"none","padding":"20px","borderRadius":"15px","boxShadow":"0 4px 18px 0 rgba(0, 0, 0, 0.1)","background":"#fff","width":"100%"}'>
				...
				<el-table
					...
					<el-table-column prop="shigushijian" label="事故时间" align="center" min-width="110">
						<template slot-scope="scope">
							<span>{{scope.row.shigushijian}}</span>
						</template>
					</el-table-column>
					<el-table-column prop="shiguleixing" label="事故类型" align="center" min-width="110">
						<template slot-scope="scope">
							<span>{{scope.row.shiguleixing}}</span>
						</template>
					</el-table-column>
					<el-table-column prop="shigudidian" label="地点" align="center" min-width="110">
						<template slot-scope="scope">
							<span>{{scope.row.shigudidian}}</span>
						</template>
					</el-table-column>
					<el-table-column prop="sfsh" label="审核" align="center" min-width="110">
						<template slot-scope="scope">
