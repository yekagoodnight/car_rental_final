 ...
 */
@TableName("cheshang")
public class CheshangEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public CheshangEntity() {
		
	}
	
	public CheshangEntity(T t) {
		try {
	 ...
	 * 设置：资质文件
	 */
	public void setZizhiwenjian(String zizhiwenjian) {
		this.zizhiwenjian = zizhiwenjian;
	}
	/**
	 * 获取：资质文件
	 */
	public String getZizhiwenjian() {
		return zizhiwenjian;
	}
	/**
	 * 设置：头像
