...
public class HaichejiluController {
    ...
    public R page(@RequestParam Map<String, Object> params,HaichejiluEntity haichejilu,
		...
		if(tableName.equals("cheshang")) {
			haichejilu.setCheshangzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
			haichejilu.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
        //设置查询条件
    ...
    public R info(@PathVariable("id") Long id){
        ...
        Map<String, String> deSens = new HashMap<>();
        //给需要脱敏的字段脱敏
        DeSensUtil.desensitize(haichejilu,deSens);
    ...
    public R save(@RequestBody HaichejiluEntity haichejilu, HttpServletRequest request){
        ...
        return R.ok().put("data",haichejilu.getId());
    }
    ...
    public R update(@RequestBody HaichejiluEntity haichejilu, HttpServletRequest request){
        //ValidatorUtils.validateEntity(haichejilu);
        //全部更新
        haichejiluService.updateById(haichejilu);
        return R.ok();
    }
    ...
    public R update(@RequestBody Long[] ids, @RequestParam String sfsh, @RequestParam String shhf){
        List<HaichejiluEntity> list = new ArrayList<HaichejiluEntity>();
        for(Long id : ids) {
            HaichejiluEntity haichejilu = haichejiluService.selectById(id);
            haichejilu.setSfsh(sfsh);
            haichejilu.setShhf(shhf);
            list.add(haichejilu);
        }
        haichejiluService.updateBatchById(list);
        return R.ok();
    }
